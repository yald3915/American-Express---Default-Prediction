This file is the baseline code for American Express - Default Prediction--Predict if a customer will default in the future

以上文件是American Express - Default Prediction--Predict if a customer will default in the future（信用违约预测大赛）比赛的baseline代码
